class Word {
  ...
  final List<String> collocations; // frequent word pairings
...
class Definition {
  final String definition; // The meaning of the word in this specific context
  final String context; // Example sentence showing how it's used
  final String partOfSpeech; // Part of speech (verb, noun, adjective, etc.)
  final List<String> examples; // List of example sentences showing usage
...
final List<Word> practiceWords = [
  Word(
      ...
      category: "Grammar",
      masteryScore: 0.7,
      collocations: ["which one", "which is better", "which option"]),
  Word(
      id: 2,
      word: "Even",
      translation: "حتى",
      ...
      category: "Adverbs",
      masteryScore: 0.5,
      collocations: ["even more", "even though", "even so"]),
  Word(
      id: 3,
      word: "Instead",
      ...
      category: "Adverbs",
      masteryScore: 0.6,
      collocations: ["instead of", "instead of doing", "instead of going"]),
  Word(
      id: 4,
      word: "Nevertheless",
      translation: "ومع ذلك",
  ...
  Word(
      ...
      category: "Conjunctions",
      masteryScore: 0.9,
      collocations: ["because of", "because she", "because it was"]),
  Word(
      id: 10,
      word: "However",
      translation: "لكن",
...
final List<Word> vocabularyWords = [
  ...
  Word(
      ...
      collocations: ['empathy for', 'show empathy', 'lack of empathy']),
  Word(
      id: 3,
      word: 'Algorithm',
  ...
  Word(
      ...
      collocations: ['versatile tool', 'versatile person', 'versatile skills']),
  Word(
      id: 10,
      word: 'Camaraderie',
      translation: 'رفقة',
